...
public class Deck
{
    ...
    public void RiffleShuffle()
    {
        ...
        List<Card> leftHalf = cards.GetRange(0, half);
        List<Card> rightHalf = cards.GetRange(half, cards.Count - half);
        ...
        while (leftHalf.Count > 0 && rightHalf.Count > 0)
        {
            if (random.Next(2) == 0)
            {
                shuffledCards.Add(leftHalf[0]);
                leftHalf.RemoveAt(0);
            }
            else
            {
                shuffledCards.Add(rightHalf[0]);
                rightHalf.RemoveAt(0);
            }
        }
        shuffledCards.AddRange(leftHalf);
        shuffledCards.AddRange(rightHalf);
        cards = shuffledCards;
    }
...
public class CardGame
{
    ...
    public void PlayGame()
    {
        ...
        Console.WriteLine("2 - No Shuffle");
        Console.WriteLine("3 - Riffle shuffle ");
